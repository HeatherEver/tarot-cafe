...
export const PentaclesCards = () => {
  ...
  useEffect(() => {
    ...
    getCards().then((cardsFromAPI) => {
      const pentaclesCards = cardsFromAPI.filter((card) => {
        return card.suit === "Suit of Pentacles";
      });
      const sortedPentacles = pentaclesCards.sort((a,b ) => a.value - b.value)
      setCards(sortedPentacles);
      setIsLoading(false);
    });
  }, []);
  ...
  if (isLoading) return <p>...loading</p>;
    ...
    return (
      ...
      <header className="suit-header-img">
        <h1 className="suit-header">Suit of Pentacles</h1>
      </header>
