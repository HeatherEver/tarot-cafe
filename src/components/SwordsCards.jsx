...
export const SwordsCards = () => {
  ...
  useEffect(() => {
    ...
    getCards().then((cardsFromAPI) => {
      const swordsCards = cardsFromAPI.filter((card) => {
        return card.suit === "Suit of Swords";
      });
      const sortedSwords = swordsCards.sort((a,b ) => a.value - b.value)
      setCards(sortedSwords);
      setIsLoading(false);
    });
  }, []);
  ...
  if (isLoading) return <p>...loading</p>;
    ...
    return (
      ...
      <header className="suit-header-img">
        <h1 className="suit-header">Suit of Swords</h1>
      </header>
